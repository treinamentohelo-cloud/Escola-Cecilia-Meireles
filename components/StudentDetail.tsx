...
import { ArrowLeft, PlusCircle, Check, AlertTriangle, Clock, ClipboardCheck, X, Star, Calendar, History, Printer, TrendingUp, TrendingDown, BookOpen, LayoutList, User as UserIcon, Flag, Table, Trophy, Hand, Activity, UserCheck } from 'lucide-react';
...
export const StudentDetail: React.FC<StudentDetailProps> = ({
  ...
  React.useEffect(() => {
      if (isModalOpen && attendancePercentage !== null && !formParticipation) {
          setFormParticipation((attendancePercentage / 10).toFixed(1));
      }
  ...
  return (
    <div className="space-y-6">
      ...
      {/* HEADER DO ALUNO */}
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 relative overflow-hidden">
